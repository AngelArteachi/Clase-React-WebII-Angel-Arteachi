...
export default function RecipeDetail({ detail }) {
  ...
  return (
    <div className="recipe-detail">
      ...
      {detail.strYoutube && (
        <a href={detail.strYoutube} target="_blank" rel="noopener noreferrer" className="link_yt">YouTube</a>
      )}
      {detail.strSource && (
        <a href={detail.strSource} target="_blank" rel="noopener noreferrer" className="link_ws">Website</a>
      )}
    </div>
  );
} 